...
class TrainLoop:
    def __init__(
        ...
        *,
        ...
        logger.log("self.model: " + str(self.model))
        logger.log("self.diffusion: " + str(self.diffusion))
    ...
    def run_step(self, batch, cond, info=dict()):
    ...
    def forward_backward(self, batch, cond):
        ...
        for i in range(0, batch.shape[0], self.microbatch):
            ...
            logger.log("lossmse", lossmse.detach())
